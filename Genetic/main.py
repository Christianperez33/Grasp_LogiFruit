...
argparser.add_argument('-ns', '--n_son', help='numero de hijos en la funcion de reproduccion', default=4)
...
if int(args.n_son)+2>=int(args.n_sup):
    ...
    with open('./Genetic/solution'+str(args.solpath.split("/")[-2])+'_'+args.iter+'.json', 'w') as outfile:
