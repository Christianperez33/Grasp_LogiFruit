...
# echo "GA"
echo "DATOS DE 5JULIO"
python3 ./Genetic/main.py -i 200   -x ./Genetic/data_grasp/5JULIO/stock.csv  -y ./Genetic/data_grasp/5JULIO/viajes.xml -s ./RESULTADOS_PAPER/IEEE/GRASPSOLS/5JULIO/1/
python3 ./Genetic/main.py -i 200   -x ./Genetic/data_grasp/5JULIO/stock.csv  -y ./Genetic/data_grasp/5JULIO/viajes.xml -s ./RESULTADOS_PAPER/IEEE/GRASPSOLS/5JULIO/5/
python3 ./Genetic/main.py -i 200  -x ./Genetic/data_grasp/5JULIO/stock.csv  -y ./Genetic/data_grasp/5JULIO/viajes.xml -s ./RESULTADOS_PAPER/IEEE/GRASPSOLS/5JULIO/10/
python3 ./Genetic/main.py -i 200  -x ./Genetic/data_grasp/5JULIO/stock.csv  -y ./Genetic/data_grasp/5JULIO/viajes.xml -s ./RESULTADOS_PAPER/IEEE/GRASPSOLS/5JULIO/20/
# echo "DATOS DE 14JULIO"
